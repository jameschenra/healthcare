...
@php
  $title = old("title", $slide->title);
  $sub_title = old("sub_title", $slide->sub_title);
  $order = old("order", $slide->order);
@endphp
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    ...
    <form method="POST" action="{{route('admin.slides.update', ['id' => $slide->id])}}" enctype="multipart/form-data" accept-charset="UTF-8">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="title" value="{{ $title }}" placeholder="Title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" />
              @if ($errors->has("title"))
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sub_title" value="{{ $sub_title }}" placeholder="Sub Title" class="form-control {{ $errors->has('sub_title') ? 'is-invalid' : '' }}" />
            ...
            <div class="col-sm-10">
              <select class="form-control" name="order">
                ...
                @for ($i = 1; $i <= $maxOrder; $i++)
                  <option value="{{ $i }}" {{ $i == $order ? 'selected' : '' }}>{{ $i }}</option>
                @endfor
              </select>
            </div>
          </div>
        ...
        <div class="box-footer">
          <div id="saveActions" class="form-group">
            ...
            <a href="{{route('admin.slides')}}" class="btn btn-default">
