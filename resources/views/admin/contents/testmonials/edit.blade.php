...
@php
  $owner = old("title", $testmonial->owner);
  $content = old("title", $testmonial->content);
  $image = old("title", $testmonial->image);
  $description = old("title", $testmonial->description);
@endphp
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    ...
    <form method="POST" action="{{route('admin.contents.testmonial.update', ['id' => $testmonial->id])}}" enctype="multipart/form-data" accept-charset="UTF-8">
      <input name="_method" type="hidden" value="PUT" />
      <input name="id" type="hidden" value="{{$testmonial->id}}" />
      @csrf
      <div class="box box-primary">
        ...
        <div class="box-body form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="owner" value="{{$owner}}" placeholder="Owner" class="form-control {{ $errors->has('owner') ? 'is-invalid' : '' }}" />
              @if ($errors->has("owner"))
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea rows="5" name="content" placeholder="Content" 
                class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}">{{ $content }}</textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="description" value="{{ $description }}" placeholder="Description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" />
