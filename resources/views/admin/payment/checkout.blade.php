				...
				<div class="row">
					...
					<div class="col-md-5">
						<form method="POST" action="{{route('admin.payment.stripe')}}" accept-charset="UTF-8" autocomplete="off" id="user-form">
							...
							<br />
							<div class="d-md-flex">
								<input type="submit" value="Checkout" class="btn btn-success" style="width:170px;height:50px;margin-left:10px;margin-top:10px;">
								<a href="{{ route('admin.users') }}">
									<input type="button" value="Cancel" class="btn btn-danger" style="width:170px;height:50px;margin-left:10px;margin-top:10px;">
								</a>
							</div>
						</form>
					</div>
